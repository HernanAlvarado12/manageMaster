const manage = [
    {
        ...
        content: `See how your day-to-day tasks fit into the wider vision. Go from tracking 
        progress at the milestone level all the way done to the smallest of details. Never 
...
const sayd = [
    {
        username: 'Anisha Li',
        content: `“Manage has supercharged our team’s workflow. The ability to maintain visibility 
        on larger milestones at all times keeps everyone motivated.”`,
        path: './assets/anisha.png'
    },
    {
        username: 'Ali Bravo',
        content: `“We have been able to cancel so many other subscriptions since using Manage. There 
        is no more cross-channel confusion and everyone is much more focused.”`,
        path: './assets/ali.png'
    },
    {
        username: 'Richard Watts',
        content: `“Manage allows us to provide structure and process. It keeps us organized and focused. 
        I can’t stop recommending them to everyone I talk to!”`,
        path: './assets/richard.png'  
    },
    {
        username: 'Shanai Gough',
        content: `Their software allows us to track, manage and collaborate on our projects from anywhere. 
        It keeps the whole team in-sync without being intrusive.”`,
        path: './assets/shanai.png'
    }
]
